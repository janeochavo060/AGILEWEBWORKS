...
export default function Menu ({ className }) {
  ...
  return (
    <div
      id="menu"
      className={`${showSideMenu ? 'h-screen md:w-[50%] md:ml-[50%] lg:w-full lg:h-fit lg:ml-0' : ''} shadow-lg lg:shadow-none bg-white fixed pt-4 pb-3 z-[100] w-full transition-all duration-600 ease-in-out ${
        className || ""
      } ${
