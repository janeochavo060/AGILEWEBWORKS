...
const Website = ({ block }) => {
  ...
  const rows = highlightedText?.split(".").map((sentence, index) => {
    return (
      <div
        key={index}
        className="flex justify-start text-[23px]  md:text-[30px] lg:text-[35px]  2xl:text-[50px]  lg:leading-[150%]"
      >
        {sentence.trim() && (
  ...
  return (
    <div className="pt-[100px] w-full h-full relative px-[20px] py-[60px] lg:px-[137px] 2xl:px-[216px] lg:py-[114px] font-jomolhari bg-[linear-gradient(to_bottom,#004E98,#8CAAC6,#FFFFFF)]">
      <div className="flex space-x-[10px]">
        <div>
          <svg
            ...
            fill="black"
            opacity="0.5"
            className="md:w-[40px] lg:w-[60px] xl:w-[80px] md:h-[60px] lg:h-[80px] xl:h-[100px]  "
          >
      ...
      <div className="text-center flex  justify-end  lg:h-[500px] ">
        <div className=" flex  ">
          <div className="  lg:pt-[20px] lg:w-[1000px] relative">
            <div
              className="xl:pr-[100px] text-center  flex flex-col items-center md:text-[15px] lg:text-[20px] xl:text-[25px]"
            ...
            <Image
             ...
             xl:top-[-65px] xl:left-[-500px] 
             w-[200px] sm:w-[300px] md:w-[350px] lg:w-[400px] xl:w-[500px] 
