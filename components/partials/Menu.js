        ...
        <div className="flex justify-between items-center h-full">
          ...
          <div className="hidden xl:flex md:mx-0 mx-4 flex-no-wrap items-center whitespace-nowrap gap-x-16 gap-y-2">
            ...
            <button
              ...
              className="px-4 py-2 transition ease-in-out delay-150 bg-primary hover:bg-sky-400 hover:-translate-y-0.5 hover:scale-110 duration-300 rounded-full text-white cursor-pointer"
              onClick={() => {}}
            >
              Get A Quote
            </button>
