        ...
        <div className="flex flex-wrap justify-center">
          <div
            className={`xl:w-1/3 order-1 ${
              slice.floatImage === "right" ? "xl:order-2 flex justify-end" : ""
            }`}
          >
            <div
              className={`${
          ...
          <div
            className={`xl:w-2/3 order-2 ${
              slice.floatImage === "right" ? "xl:order-1" : ""
            }`}
          >
            <p className="text-main-black text-center xl:text-left my-4 mb-8 font-extrabold text-[31px] sm:text-xl md:text-2xl xl:text-3xl">
