export default function MainPageHeader ({slice}) {
    return (
        <div
            className="relative w-auto bg-no-repeat bg-cover bg-center mt-12 sm:mt-28 md:mt-24 lg:mt-20 xl:mt-12 2xl:mt-20 mb-4 sm:mb-12 md:mb-16 lg:mb-14 xl:mb-16 2xl:mb-28 h-[290px] sm:h-[360px] md:h-[460px] lg:h-[550px] xl:h-[700px]"
            style={{
