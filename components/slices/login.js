...
export default function Slice () {
  return (
    <div className="mt-32 my-16 text-white flex justify-center">
      <div className="w-full p-4 py-16 bg-[#04316C] text-sm leading-[30px] sm:text-base md:max-w-[670px] md:px-16 md:rounded-3xl">
